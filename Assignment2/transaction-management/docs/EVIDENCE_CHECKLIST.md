...
- [ ] Sign up a new account at `/signup` and confirm it is created as GUEST
- [ ] Sign in as `admin@txnmanager.dev`
- [ ] Sign in as `alice@txnmanager.dev`
- [ ] Sign in as `guest@txnmanager.dev`
...
- [ ] As GUEST, visiting `/transactions` redirects away
...
| Request | Signed out | GUEST | MEMBER | ADMIN |
| --- | --- | --- | --- | --- |
| `GET /api/transactions` | 401 | 403 | 200 | 200 |
| `POST /api/transactions` | 401 | 403 | 201 | 201 |
| `GET /api/admin/users` | 401 | 403 | 403 | 200 |
| `GET /api/admin/audit-logs` | 401 | 403 | 403 | 200 |
| `GET /api/users` | 401 | 200 | 200 | 200 |
